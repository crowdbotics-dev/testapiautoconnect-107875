...
## Project Structure
    ...
    ├── testapiautoconnect_107875  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_107875`
...
2. Clone this repo and `cd testapiautoconnect_107875`
